...
class Inceptionv1FCN8s:
    ...
    def _build_summary_ops(self):
        ...
        add_variable_summaries(variable=graph.get_tensor_by_name('inception_3b_pool_proj/weights:0'), scope='inception_3b_pool_proj')
        add_variable_summaries(variable=graph.get_tensor_by_name('inception_3b_pool_proj/biases:0'), scope='inception_3b_pool_proj')
