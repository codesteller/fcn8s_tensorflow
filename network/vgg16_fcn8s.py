...
class Vgg16FCN8s:
    ...
    def _evaluate(self, eval_dir, data_generator, metrics, num_batches, l2_regularization, description='Running evaluation'):
        '''
    ...
    def evaluate(self, eval_dir, data_generator, num_batches, metrics={'loss', 'mean_iou', 'accuracy'}, l2_regularization=0.0,
                 dataset='val'):
        '''
        ...
        self._evaluate(eval_dir, data_generator, metrics, num_batches, l2_regularization, description='Running evaluation')
